...
export const meta: MetaFunction = () => {
	return [{ title: "Account Created ✽ ttucampus" }];
};
	...
	return (
		<div className="container mx-auto h-[60vh]">
			<div className="mx-auto max-w-[24rem] rounded-lg border  bg-white p-4 dark:border-neutral-700 dark:bg-neutral-800">
				...
				<p className="mt-2">
					You may not be able to add or edit content on ttucampus until you verify
					your account.
				</p>

				{school === "knust" && <TtuLoginDirection />}

				<div className="mt-2 text-secondary">
					<a
						className="underline"
						target="_blank"
						href="https://wa.me/233504232140"
						rel="noreferrer"
					>
						Click here
					</a>{" "}
