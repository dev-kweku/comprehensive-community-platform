...
export const action = async ({ request }: ActionFunctionArgs) => {
	...
	const link = [
		`https://ttucampus.org/reset-password?`,
		`email=${email}`,
	...
	await send({
		to: user.email,
		from: "m@ttucampus.org",
		subject: "Reset Password ✽ ttucampus",
...
export const meta = () => {
	return [{ title: "Forgot Password ✽ ttucampus" }];
};
					...
					>
						...
						{fetcher.data ? (
							<>
								...
								{school.id === "knust" && <TtuLoginDirection />}
							</>
						) : (
							<>
