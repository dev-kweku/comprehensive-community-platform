...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
	return [
		{ title: `Your Market Profile | ${data?.school.shortName} ✽ ttucampus` },
		{
			name: "description",
			content: "Set up your market profile to be able to sell on ttucampus.",
		},
	];
};
		...
		<div className="container mx-auto min-h-[60vh]">
			<div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
				<div className="col-span-1 lg:col-span-3">
					...
					<p>
						Set up your market profile to be able to sell on ttucampus. These
